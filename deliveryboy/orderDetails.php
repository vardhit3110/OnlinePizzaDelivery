...
$query = "SELECT o.*, u.firstName, u.lastName, d.first_name AS deliveryBoyFirstName, d.last_name AS deliveryBoyLastName 
          ...
          WHERE o.delivery_boy_id = ? AND o.orderStatus IN (1,2,3)
            ...
            <div class="table-title" style="border-radius: 14px; background: #3b8996; padding: 10px; color: white;">
                <div class="row">
                    ...
                    <div class="col-sm-8 text-right">
                        <a href="#" onclick="window.print()" class="btn btn-info"><i class="fa fa-print"></i>
                            <span>Print</span></a>
                    </div>
                </div>
            </div>
                    ...
                    <?php if ($result->num_rows > 0): ?>
                        <?php while ($order = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><a href="#" data-toggle="modal" data-target="#orderStatus<?php echo $order['orderId']; ?>"
                                        class="view"><i class="material-icons">&#xE5C8;</i></a></td>
                                <td><a href="#" data-toggle="modal" data-target="#orderItem<?php echo $order['orderId']; ?>"
                                        class="view"><i class="material-icons">&#xE5C8;</i></a></td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
