...
// Fetch reviews for orders assigned to this delivery boy
$sql = "SELECT r.reviewId, u.username, r.orderId, r.rating, r.reviewDate 
        FROM reviews r
    ...
    <div class="container-fluid" style="margin-top: 20px; padding-top: 20px;">
        <div class="row">
            <div class="card col-lg-12">
                <div class="card-body">
                    <h2 class="text-center mb-4">Your Delivery Reviews</h2>
