            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="contact-box p-4">
                  ...
                  if ($userId > 0) {
                    $passSql = "SELECT email, phone FROM users WHERE id='$userId'";
                  ...
                  <form action="partials/_manageContactUs.php" method="POST">
                    <div class="row">
                        ...
                        <div class="form-group mt-3">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone"
                              ...
                              pattern="[0-9]{10}" value="<?php echo $phone ?>" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group mt-3">
                          ...
                          <input class="form-control" type="text" id="orderId" name="orderId" placeholder="Order Id"
                            value="0">
                          <small id="orderIdHelp" class="form-text text-muted">If your problem is not related to the
                            order(order id = 0).</small>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group mt-3">
                      ...
                      <?php } else { ?>
                        <div class="col-lg-12">
                          <button type="submit" class="btn btn-danger-gradiant mt-3 text-white border-0 py-2 px-3"
              ...
              echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact.jpg)">
                          <div class="detail-box p-4">
                            ...
                            <div class="round-social light">
                              ...
                              <a href="https://github.com/henibalar" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
