        ...
        <div class="container">
            ...
            <div class="row">
                <div class="jumbotron p-3 mb-3"
                    ...
                    <div class="user-info">
                        <img class="rounded-circle mb-3 bg-dark" src="img/person-<?php echo $username; ?>.jpg"
                        ...
                        <form action="partials/_manageProfile.php" method="POST">
                            <small>Remove Image: </small><button type="submit" class="btn btn-danger"
                ...
                <div class="content-panel mb-3" style="display: flex;justify-content: center;">
                    <div class="border p-3"
                        ...
                        <h2 class="title text-center">User Profile<span class="pro-label label label-warning"> 
                        ...
                        <form action="partials/_manageProfile.php" method="post">
                            ...
                            <button type="submit" name="updateProfileDetail" class="btn btn-primary">Update Profile</button>
                        </form>
                    </div>
                </div>
            </div>
